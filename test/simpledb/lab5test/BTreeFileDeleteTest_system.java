...
public class BTreeFileDeleteTest_system extends SimpleDbTestBase {
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(BTreeFileDeleteTest_system.class);
	}
}